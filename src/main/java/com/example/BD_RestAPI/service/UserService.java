...
public class UserService {
    ...
    public List<UserEntity> buscarPorNome(String nome) { return userRepository.findByNomeIgnoreCase(nome);}

    public List<UserEntity> buscarPorEmail(String email) { return userRepository.findByEmailIgnoreCase(email);}
